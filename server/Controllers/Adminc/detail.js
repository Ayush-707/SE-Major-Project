...
const Detail = require("../../Database/Models/userAccounts");


exports.sendA = async (req, res) => {
  try {
    const tableData = await Detail.find();
