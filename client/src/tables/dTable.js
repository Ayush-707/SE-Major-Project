  ...
  return (
    <>
      <div className="sm:flex sm:gap-x-2">
        ...
        />
        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-3 rounded-full" style={{ marginLeft: "auto", }} onClick={() => navigate("../../Admin/Deposit")} >Deposit Money</button>
