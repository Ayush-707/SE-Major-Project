...
import {Deposit} from '../../Services/APIs/AdminAPI';
    ...
    <div className="flex flex-col items-center justify-center h-screen">
      ...
      {confirming ? (
        <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
          ...
          <p className="mb-4">
            You are about to deposit {amount} units to the account with ID{" "}
            {id}.
          </p>
          <p className="mb-4">
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-gray-200">
      ...
      {confirming ? (
        <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
          ...
          <p className="mb-4">
            You are about to deposit {amount} units to the account of this ID{" "}
            {accountNumber}.
          </p>
          <p className="mb-4">
            Please review the details and click "Confirm" to proceed or "Cancel"
